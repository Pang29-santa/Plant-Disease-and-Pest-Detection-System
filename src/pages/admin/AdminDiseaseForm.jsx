...
const AdminDiseaseForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate(fromPage > 1 ? `/admin/diseases?page=${fromPage}` : '/admin/diseases');
        } catch (err) {
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 w-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-4 pt-6 border-t">
                        <Link to={fromPage > 1 ? `/admin/diseases?page=${fromPage}` : '/admin/diseases'} className="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 flex items-center transition-colors">
