    ...
    return (
        <AdminLayout title={t('admin.diseases.title')}>
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                <h2 className="text-2xl font-bold text-primary-800">{t('admin.diseases.diseaseListTitle')}</h2>
                ...
                <div className="flex flex-col md:flex-row items-center gap-2 w-full md:w-auto">
                    ...
                    <Link to="/admin/diseases/new" state={{ defaultType: '1' }} className="bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded flex items-center gap-2 whitespace-nowrap transition-colors">
                                    ...
                                    <tr key={item._id || item.ID} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div className="flex items-center gap-3">
                                                <Link to={`/admin/diseases/view/${item._id}?page=${page}`} className="text-blue-600 hover:text-blue-900" title={t('admin.users.actions.view')}>
                                                    <Eye className="w-5 h-5" />
                                                </Link>
                                                <Link to={`/admin/diseases/edit/${item._id}?page=${page}`} className="text-yellow-600 hover:text-yellow-900" title={t('admin.editInfo')}>
