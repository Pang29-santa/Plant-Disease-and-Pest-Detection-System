    ...
    return (
        <AdminLayout title={t('admin.diseases.title')}>
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                <h2 className="text-2xl font-bold text-green-800">{t('admin.diseases.pestListTitle')}</h2>
                ...
                <div className="flex flex-col md:flex-row items-center gap-2 w-full md:w-auto">
                    ...
                    <Link to="/admin/pests/new" state={{ defaultType: '2' }} className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded flex items-center gap-2 whitespace-nowrap transition-colors">
