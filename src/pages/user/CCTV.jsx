...
import { Camera, ChevronLeft, ArrowRight, Video } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[#F8FAFC] p-4 flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="max-w-xl w-full relative z-10">
                ...
                <div className="bg-white p-12 rounded-[3rem] shadow-2xl shadow-gray-200/50 text-center border border-gray-100 flex flex-col items-center">
                    <div className="w-24 h-24 bg-blue-50 rounded-[2rem] flex items-center justify-center text-blue-600 mb-8 shadow-inner relative group overflow-hidden">
                        <Camera className="w-10 h-10 group-hover:scale-110 transition-transform duration-500" />
                        <div className="absolute inset-0 bg-blue-400/10 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                    ...
                    <button 
                        onClick={() => navigate('/dashboard')}
                        className="w-full py-4 bg-gray-900 text-white rounded-2xl font-black hover:bg-blue-600 transition-all shadow-xl shadow-gray-200 flex items-center justify-center gap-2 group active:scale-95"
                    >
                        {t('profile.backHome')}
