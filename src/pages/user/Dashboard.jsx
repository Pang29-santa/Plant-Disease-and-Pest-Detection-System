...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 pb-24">
      ...
      <div className="relative bg-primary-900 pt-12 pb-32 px-4 overflow-hidden">
        {/* Dynamic Background */}
        ...
        <div className="absolute bottom-0 left-0 -ml-24 -mb-24 w-96 h-96 bg-primary-400/10 rounded-full blur-[120px]" />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-6 group">
              <div className="relative">
                ...
                <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-primary-500 border-4 border-primary-900 rounded-full flex items-center justify-center shadow-lg">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[10px] font-black text-primary-300 uppercase tracking-[0.3em]">
            ...
            <div className="flex items-center gap-3">
               ...
               <button 
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-white text-primary-900 rounded-2xl transition-all font-black text-xs uppercase tracking-widest hover:bg-primary-400 hover:text-white active:scale-95 shadow-xl shadow-black/20"
               >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {menuActions.map((item, index) => (
            <div
              ...
              className="bg-white p-6 rounded-[2rem] shadow-xl shadow-gray-200/50 border border-transparent hover:border-primary-100 flex flex-col gap-4 hover:-translate-y-1 transition-all duration-300 group cursor-pointer relative overflow-hidden active:scale-95"
            >
              <div className="relative z-10">
                <div className={`w-14 h-14 bg-gradient-to-br ${item.color} rounded-xl flex items-center justify-center text-white ${item.shadow} shadow-lg transform group-hover:scale-105 group-hover:rotate-3 transition-all duration-300`}>
              ...
              <div className="relative z-10 mt-2">
                {item.badge && (
                  <span className="inline-block px-3 py-1 bg-primary-50 text-primary-600 text-[10px] font-black uppercase tracking-widest rounded-full mb-3">
                    {item.badge}
                  </span>
                )}
                ...
                <p className="text-xs text-slate-500 leading-relaxed font-bold line-clamp-2">
                  {item.desc}
                </p>
              </div>

              <div className="mt-4 flex items-center justify-between relative z-10">
                <div className="w-10 h-10 rounded-full bg-secondary-50 flex items-center justify-center group-hover:bg-primary-50 transition-colors">
                  <ChevronRight className="w-5 h-5 text-gray-300 group-hover:text-primary-600 transition-all" />
                </div>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {secondaryActions.map((item, index) => (
              <button
                key={index}
                onClick={() => navigate(item.path)}
                className="flex items-center justify-between p-5 bg-white rounded-[2rem] border border-gray-100 shadow-lg shadow-gray-100/50 hover:shadow-xl hover:shadow-gray-200/50 transition-all duration-300 group"
              >
                ...
                <div className="w-10 h-10 rounded-full bg-secondary-50 flex items-center justify-center group-hover:translate-x-1 transition-all">
                  <ArrowRight className="w-4 h-4 text-secondary-300 group-hover:text-primary-600" />
                </div>
              </button>
            ))}
          </div>

          <div className="bg-primary-900 rounded-[3rem] p-10 text-white flex flex-col justify-between gap-10 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-64 h-64 bg-primary-400 opacity-[0.03] rounded-full -mr-32 -mt-32 blur-3xl group-hover:opacity-10 transition-opacity duration-1000" />
            ...
            <button 
              ...
              className="w-full py-5 bg-primary-600 hover:bg-primary-500 text-white rounded-[2rem] shadow-2xl shadow-primary-900/40 transition-all font-black text-sm uppercase tracking-[0.2em] active:scale-95 relative z-10 group/btn"
            >
